...
//! RISC-V 64-bit trap-entry saved-register mirrors.
//!
...
//! (they are plain shared storage); what is missing is the riscv64
//! `ecall`/trap-vector path that would populate them on a real syscall
//! entry.
